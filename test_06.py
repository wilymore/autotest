...
class Test(unittest.TestCase):
    ...
    def test06(self):
        ...
        url = 'http://appcenter-50.tclclouds.com/appcenter-api-server/api/searchservice/findSearchApps'
        data = {"$ARGS": ["camera", 1, 0, ""],
        ...
        dic = r.json()
        first = dic.get('simpleApps')[0]
        print(first)
        print(first['id'])
        self.assertEqual(first['id'], 1956150, u'搜索接口返回错误')
