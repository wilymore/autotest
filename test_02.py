...
class Test(unittest.TestCase):
    '''AppCenter应用榜接口测试'''
    def test02(self):
        url = 'http://appcenter-50.tclclouds.com/appcenter-api-server/api/rankingservice/findAppRankingApps'
        data = {"$ARGS":[1],"$BASE_PARAM":{"birthDay":"","channelName":"AOTA","countryId":-1,
                                           "countryMCC":"460","deviceId":-1,"deviceType":"mobile",
                                           "distributorId":-1,"fingerPrint":"HUAWEI/EVA-AL10/HWEVA:8.0.0/HUAWEIEVA-AL10/535(C00):user/release-keys",
        ...
        print(sec)
        self.assertEqual(sec, 'com.facebook.orca', u'榜单接口返回错误')
